...
from models.convnext_transition import ConvNeXtTransition
...
def main():
    ...
    model = ConvNeXtTransition(label_hierarchy, pretrained=True, fine_to_coarse=True).cuda()
    ...
    optimizer = torch.optim.SGD([
        ...
        {'params': model.extractor.parameters(), 'lr': args.lr * 0.01}], lr=args.lr, momentum=0.9, weight_decay=5e-4)
