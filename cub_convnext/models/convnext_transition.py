...
class ConvNeXtTransition(nn.Module):
    def __init__(self, label_hierarchy, hid_dim=600, pretrained=False, fine_to_coarse=False, sprite_dim=2):
        ...
        # self.extractor = convnext_tiny(weights=ConvNeXt_Tiny_Weights.IMAGENET1K_V1)
        self.extractor = convnext_base(weights=ConvNeXt_Base_Weights.IMAGENET1K_V1)
        self.feature_dim = self.extractor.classifier[2].in_features
